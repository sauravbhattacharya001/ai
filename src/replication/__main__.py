...
_HAS_MAIN = {
    "alert_router", "alignment", "anomaly_replay", "attack_tree", "audit_trail", "behavior_profiler", "canary", "capacity", "fleet", "ir_playbook", "maturity_model", "preflight", "radar", "risk_heatmap", "policy_linter", "sla_monitor", "safety_warranty", "tabletop",
