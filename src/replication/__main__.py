...
_HAS_MAIN = {
    ...
    "blast_radius", "correlation_graph", "deception_detector", "evasion", "metrics_aggregator", "postmortem", "safety_benchmark", "safety_drill", "safety_gate", "supply_chain", "threat_correlator", "trend_tracker",
