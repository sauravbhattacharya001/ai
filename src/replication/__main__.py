...
_HAS_MAIN = {
    ...
    "blast_radius", "correlation_graph", "deception_detector", "evasion", "metrics_aggregator", "safety_benchmark", "safety_drill", "supply_chain", "threat_correlator", "trend_tracker",
